package com.languohui.lgh.generator;
...
public class CodeGenerator {
    public static void main(String[] args) {
        ResourceBundle rb = ResourceBundle.getBundle("project-generator");
        AutoGenerator mpg = new AutoGenerator();
        //全局配置
        GlobalConfig gc = new GlobalConfig();
        gc.setOutputDir(rb.getString("servicePath")+"/src/main/java");//输出文件路径
        gc.setFileOverride(true); // 是否文件覆盖
        gc.setActiveRecord(true);// 不需要ActiveRecord(实体类继承Model)特性的请改为false
        ...
        strategy.setInclude("t_project_type");//生成的表
